                ...
                <div class="x_panel ui-ribbon-container">
                  ...
                  <div class="x_content">
                    <div class="x_title" style="max-width: 500px;">
                      <h2><i class="fa fa-plus"></i> New Donor
                      </h2>
                      <div class="clearfix"></div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      <input type="text" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Display Name">
                      ...
                      <div class="x_content">
                        ...
                        <form action="charged.php" method="POST">
                          <script
                              ...
                              src="https://checkout.stripe.com/checkout.js" class="stripe-button" target="_self"
                              data-key="pk_test_k1MtbvunaQLvSFILBRnkJT6w"
                              data-amount= "4000000"
                              data-name="DiSolver"
                              plan="subs_vol"
                              data-currency="LKR"
                              ...
                              data-label="Create Donor Account"
