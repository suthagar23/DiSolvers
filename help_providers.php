        ...
        <div class="right_col" role="main">
              ...
              <div class="row"  style="margin-top: 60px;">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2><i class="fa fa-align-left"></i> Help Requests
                          <span class="badge badge-success" style="color: #ffffff;">3</span></h2>
                        ...
                        <div class="accordion" id="accordion" role="tablist" aria-multiselectable="true">
                              ...
                              <div class="panel-body" style="padding-top: 0px; padding-bottom: 0px;">
                                <div class="x_content">
                                  <div class="dashboard-widget-content">
                                    ...
                                    <div class="flex">
                                      <button type="button" class="btn btn-danger" style="float: left;">Cancel</button>
                                      <a href="during_helping.php">
                                        <button type="button" class="btn btn-info" style="float: right;">Accept Request</button>
                                      </a>
                                    </div>
                                  </div>
                                </div>
                          ...
                          <div class="panel">
                            <a class="panel-heading collapsed" role="tab" id="headingTwo" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo2" aria-expanded="false" aria-controls="collapseTwo">
                              <h4 class="panel-title" style="padding-bottom: 0px; margin-bottom: 0px;">
                                <span class="image user-profile"><img src="images/img.jpg" alt="Profile Image" /></span>
                                Ramraj <small>@cram8</small>
                                <span class="label label-danger" style="float: right;">
                                  14 <i class="fa fa-bullseye"></i>
                                </span>
                              </h4>
                              <h6 style="padding-left: 40px; margin-top: -5px; margin-bottom: 0px; padding-bottom: 0px;">9km away | 40m</h6>
                              <div style="float:right; margin-top: -8px;">
                                <i class="fa fa-clock-o"></i> 7min
                              </div>
                            </a>
                          ...
                          <div class="panel">
                            <a class="panel-heading collapsed" role="tab" id="headingTwo" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                              <h4 class="panel-title" style="padding-bottom: 0px; margin-bottom: 0px;">
                                <span class="image user-profile"><img src="images/img.jpg" alt="Profile Image" /></span>
                                Poorana Vijith <small>@poorana8</small>
                                <span class="label label-danger" style="float: right;">
                                  14 <i class="fa fa-bullseye"></i>
                                </span>
                              </h4>
                              <h6 style="padding-left: 40px; margin-top: -5px; margin-bottom: 0px; padding-bottom: 0px;">2km away | 12m</h6>
                              <div style="float:right; margin-top: -8px;">
                                <i class="fa fa-clock-o"></i> 14min
                              </div>
                            </a>
